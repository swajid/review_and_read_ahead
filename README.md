...
<!-- DVOmxLxmXuY q6drd4J-TBg k1k6EUW0czc v=R--2Ty9hj-A amJNTsfl8MU KxgNsN4yjLQ NnBhBhJEc2Y zEacJV-423o kMGwZKgikws YrkCoaZFoDs _jHYSIq16nw 8DDbUv1ppig Z5q9hHmGECk BQZ624p4uGU fewVRtkf8_o eyj7JhIdBlc e5YmG3jkzxA qr5JMMaJt6g vL1wPp9UtKM ZghtCtwU0gQ 25s17jID6gs AVPEP_KSldA eQF7cqkiR6I dtZ8MhEbmVc-->
...
LATER
- [ ] **Table of contents/diagram of sections** -> [Yet another ‘R for Data Science’ study guide](https://brshallo.github.io/r4ds_solutions/)
- [ ] ~~Automate this markdown -> auto-alphabetical order~~ 
- [ ] [Statistics in Medicine](https://lagunita.stanford.edu/courses/Medicine/MedStats-SP/SelfPaced/about)
...
* [2018 - Serverless computing provides on-demand high performance computing for biomedical research](https://arxiv.org/abs/1807.11659) https://github.com/BioDepot/RNA-seq-lambda https://twitter.com/russpoldrack/status/1214627201875709953?s=21  <-- !!!!! -->
...
* [Create HTML Table with knitr::kable and kableExtra](https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_html.html)
* [Zotero and RStudio](https://ikashnitsky.github.io/2019/zotero/)
...
* `"There are (and will be) so many papers to read and time is limited; we are using NLP/text algorithms to summarize and rank papers to narrow down which ones we should be reading more in depth" - undergrad Prof (~2012)`
...
* [NVIDIA is releasing the Clara Genomics Analysis SDK – an open source toolkit for biological sequence analysis, that is part of Clara Genomics](https://news.developer.nvidia.com/clara-genomics-analysis-sdk-goes-open-source/)
...
- [ ] [Single-Cell Research - An Overview of Recent Single-Cell Research Publications](https://www.illumina.com/content/dam/illumina-marketing/documents/products/research_reviews/single-cell-sequencing-research-review.pdf)
* [Scanpy – Single-Cell Analysis in Python](https://scanpy.readthedocs.io/en/stable/)
* [`iCellR` is an interactive R package to work with high-throughput single cell sequencing technologies (i.e scRNA-seq, scVDJ-seq and CITE-seq)](https://github.com/rezakj/iCellR)
...
* [Build A R Shiny App (Tutorial) - Wedding Risk Model](https://www.business-science.io/business/2019/06/09/Wedding-Risk-Model-App.html)
...
* [PyGotham](https://www.youtube.com/channel/UCTse88P9vOnsMaovjNl1YBA/videos?view=0&sort=p&flow=grid)
* [R/Medicine conference is to promote the use of the R programming environment and the R ecosystem in medical research and clinical practice.](https://r-medicine.com)
...
* [[Neural Information Processing Systems Previous Papers]](https://papers.nips.cc/book/advances-in-neural-information-processing-systems-31-2018) 
...
* 2021 - [Super-resolved spatial transcriptomics by deep data fusion](https://www.nature.com/articles/s41587-021-01075-3) + [XFuse: Deep spatial data fusion](https://github.com/ludvb/xfuse)  <- reading code https://github.com/ludvb/xfuse/blob/master/xfuse/model/xfuse.py
...
* 2019 - [A visual tool for defining reproducibility and replicability](https://www.nature.com/articles/s41562-019-0629-z.epdf?author_access_token=ZQy8qRAFkxuRU__93ufz19RgN0jAjWel9jnR3ZoTv0OIGe9ioYXHlijVGRoA31h64zX7NphK2wlZ8K6dxauaGtc2NVMFR-zryKq_xd3DgLZtTjEi7d1iNKt2n3FvY_wm5xb7rwk0X0qzYFSoEISQSA%3D%3D) -> Fig 1 (`mkdir figures` for figures)
* 2019 - [BOINC: A Platform for Volunteer Computing](https://arxiv.org/abs/1903.01699)
* 2019 - [Dealing With Software Collapse](https://ieeexplore.ieee.org/document/8701540)
* 2019 - [Metascape provides a biologist-oriented resource for the analysis of systems-level datasets -> _Maintaining updated data sources_](https://www.nature.com/articles/s41467-019-09234-6)
* 2019 - [Benefits and limitations of genome-wide association studies](https://www.nature.com/articles/s41576-019-0127-1)
* 2019 - [Packaging data analytical work reproducibly using R (and friends)](https://peerj.com/preprints/3192/)
* 2019 - [Machine learning and complex biological data](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-019-1689-0)
* 2019 - [Deep learning: new computational modelling techniques for genomics](https://www.nature.com/articles/s41576-019-0122-6)
* 2019 - [Orchestrating Single-Cell Analysis with Bioconductor](https://www.biorxiv.org/content/10.1101/590562v1)
* 2019 - [Elements and Principles of Data Analysis](https://arxiv.org/abs/1903.07639)
...
* 2018 - [Bayesian deep learning for single-cell analysis](https://www.nature.com/articles/s41592-018-0230-9)
* 2018 - [Cloud computing applications for biomedical science: A perspective](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1006144)
* 2018 - [Cloud computing for genomic data analysis and collaboration](https://www.nature.com/articles/nrg.2017.113)
...
* 2005 - [BitTorrent](http://web.cs.ucla.edu/classes/cs217/05BitTorrent.pdf)
    * [Enhancing Bittorrent-Like Peer-To-Peer Content Distribution With Cloud Computing (2008)](https://conservancy.umn.edu/handle/11299/201737)
